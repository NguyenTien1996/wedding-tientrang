    ...
    <div class="relative">
      <section class="relative mx-auto" style="background: rgb(251, 247, 245);">
        ...
        <div class="z-20 grid md:grid-cols-2 justify-center items-center lg:px-[300px] gap-8">
          ...
          <!-- Bride -->
          <div class="relative text-center" data-aos="fade-left" data-aos-delay="100" style="max-width: 80%;margin: auto;">
            <img 
              src="/assets/5.png" 
           ...
           <!-- Groom -->
           <div class="relative text-center mt-4 md:mt-0" data-aos="fade-right" data-aos-delay="100" style="max-width: 85%;margin: auto;">
            <img 
              src="/assets/4.png" 
            ...
            <p class="text-lg md:text-2xl text-dark-200 font-prata mt-8">Chú rể</p>
            <div class="relative">
